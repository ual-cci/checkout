jQuery(document).ready(function($) {
	var options = {
		...
		content: '<p class="pw len">8 characters or more</p><p class="pw up">1 or more uppercase letters</p><p class="pw low">1 or more lowercase letters</p><p class="pw num">1 or more numbers</p><p class="pw special">1 or more special characters</p><p class="pw mat">Passwords match</p>',
		html: true,
		placement: 'top'
	}
